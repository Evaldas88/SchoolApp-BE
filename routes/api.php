...
Route::get('schools/search/{name?}', [SchoolsController::class, 'search']);
...
Route::get('applicationsS/{id}', [ApplicationsController::class, 'show'])->middleware('auth:api');
...
Route::delete('applicationS/{id}', [ApplicationsController::class, 'destroyAppl'])->middleware('auth:api');     